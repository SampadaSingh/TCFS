    ...
    $error = "Group size must be greater than zero.";
        ...
        $stmt = $conn->prepare("
            INSERT INTO trips(
                ...
                duration_days, travel_mode, budget_label, budget_min, budget_max,
                group_size_label, group_size_min, group_size_max,
                preferred_gender, preferred_age, trip_style, description, collaborator_id, status
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending')
        ");

        $stmt->bind_param(
            "issssssississsisissi",
            $user_id,
            $name,
            $destination,
            $start_place,
...
<body>
    ...
    <div class="main-content">
        ...
        <form method="post">
            ...
            <div class="form-section">
                <h5><i class="fas fa-users"></i> Group Settings</h5>
                <div class="grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            min="5"
                            required
                            value="<?= htmlspecialchars($_POST['group_size_min'] ?? '5') ?>">
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="5"
                            required
                            value="<?= htmlspecialchars($_POST['group_size_max'] ?? '') ?>">
                    </div>
                </div>
            </div>
    ...
    <div class="form-section">
        ...
        <div class="grid-cols-2">
            <div>
                ...
                <select name="preferred_age" class="form-select" required>
                    <?php
                    $ages = ["Any", "18-25", "25-35", "35-50", "50+"];
                    foreach ($ages as $a) {
                        $selected = (($_POST['preferred_age'] ?? '') == $a) ? 'selected' : '';
